...
export default function NotFound() {
  return (
    <div className="flex min-h-dvh flex-col bg-bom-marble text-bom-black">
      <SiteChromeRail railClassName="flex justify-center pb-4 pt-10 sm:justify-start sm:pb-6 sm:pt-12">
        <Link
          href="/"
      ...
      >
        <SiteChromeRail railClassName="flex min-h-0 flex-1 flex-col items-center justify-center gap-8 pb-24 text-center">
