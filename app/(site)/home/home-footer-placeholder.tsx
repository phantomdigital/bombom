...
export default function HomeFooterPlaceholder() {
  return (
    <footer className="w-full shrink-0 bg-bom-dark-blue py-14 text-bom-white sm:py-16">
      <SiteChromeRail>
        <div className="flex flex-col gap-8 sm:gap-10">
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-2xl font-sans text-base leading-relaxed text-bom-white/80 sm:text-lg">
              Placeholder footer for contact details, opening hours, socials, and newsletter
              wiring.
            </p>
          </div>
